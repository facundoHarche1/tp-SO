...
t_config* iniciarConfig(char* path)
{
    ...
    //t_config* nuevo_config = config_create("/home/fmigliavacca/Documents/tp-2024-1c-BCM/memoria/memoria.config");
	//t_config* nuevo_config = config_create("/home/barla/Escritorio/tp-2024-1c-BCM/memoria/memoria.config");
...
int crearConexiones(t_log* logger, t_valoresM valores, t_list* listaProcesos, void* memoria, t_list* directorio, t_bitarray* framesMemoria)
{
    ...
    *argumentosCPU = *argumentosKernel;
    crearHiloEscucha(argumentosCPU);
